...
public class ChaosCompassView extends View {
    ...
    public ChaosCompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDarkRedPaint.setColor(context.getResources().getColor(R.color.colorDarkRed));

        mDeepGrayPaint = new Paint();
        mDeepGrayPaint.setStyle(Paint.Style.STROKE);
        mDeepGrayPaint.setAntiAlias(true);
        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.colorDeepGray));

        mLightGrayPaint = new Paint();
        mLightGrayPaint.setStyle(Paint.Style.FILL);
        mLightGrayPaint.setAntiAlias(true);
        mLightGrayPaint.setColor(context.getResources().getColor(R.color.colorDeepDark));
        ...
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.colorDeepDark));
        ...
        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.colorDeepDark));
    ...
    private void drawInnerCircle() {
        mInnerShader = new RadialGradient(width / 2, mOutSideRadius + mTextHeight, mCircumRadius - 40, getResources().getColor(R.color.colorDeepDark),
                getResources().getColor(R.color.colorBlack), Shader.TileMode.CLAMP);
    ...
    private void drawCenterText() {
        String centerText = String.valueOf((int) value + "°");
        ...
        mCanvas.drawText(centerText, width / 2 - centerTextWidth / 2, mTextHeight + mOutSideRadius + centerTextHeight / 4, mCenterPaint);
    }
    ...
    private void drawCompassDegreeScale() {
        ...
        mCanvas.rotate(-value, width / 2, mOutSideRadius + mTextHeight);
